...
<nav aria-label="breadcrumb" class="navbar-breadcrump bg-light rounded">
    <ol class="breadcrumb p-3">
        ...
        <li class="breadcrumb-item  font-size-12 active" aria-current="page">ویرایش اولویت تیکت</li>
    </ol>
</nav>
    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="main-body-container-bottom">
                <form action="{{ route('ticket.prioriy.update', $ticketPriority->id) }}" method="POST"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="form-group col-md-6 py-2">
                            ...
                            <select id="status" name="status" class="form-control">
                                <option value="0" @if(old('status', $ticketPriority->status) == 0) selected @endif>غیر
                                    فعال
                                </option>
